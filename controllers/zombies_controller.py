...
def view_zombie(id):
    zombie_to_view = zombie_repository.select(id)
    bite_victims = zombie_repository.bite_victims(zombie_to_view)
    return render_template('zombies/show_zombie.html', zombie=zombie_to_view, bite_victims = bite_victims)
